...
namespace Blacklite.Features.Factory
{
    public class FeatureCompositionProvider : IFeatureCompositionProvider
    {
        ...
        {
            _composers = preFeatureComposers
                    .OrderByDescending(z => z.Priority)
                    .Concat(globalComposers
                        .OrderByDescending(z => z.Priority))
                    .Concat(postFeatureComposers
                        .OrderByDescending(z => z.Priority))
                .ToArray();
            ...
            where TFeature : class, new()
        {
            ...
            if (_featureComposers.TryGetValue(typeof(TFeature), out composers)) return composers;
